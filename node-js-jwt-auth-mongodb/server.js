...
// parse requests of content-type - application/json || analyser les requêtes de type de contenu - application / json
...
// simple route
app.get("/", (req, res) => {
  res.json({ message: "Welcome to Maliki application." });
});
...
// set port, listen for requests || définir le port, écouter les demandes
